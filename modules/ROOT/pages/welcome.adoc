...
image:calendar.png[] November 2022 -> Current
...
* Performed upkeep and maintenance of Laser CNC equipment, utilizing CAD software for machine upgrades, and leveraging experimentation and customer feedback to recommend improvements to software and electrical hardware components of products.
